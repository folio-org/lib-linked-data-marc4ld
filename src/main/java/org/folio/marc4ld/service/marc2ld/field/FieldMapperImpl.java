...
public class FieldMapperImpl implements FieldMapper {
  ...
  private final Marc2ldFieldRule fieldRule;
  ...
  public Collection<Resource> createResources(Resource parent) {
    ...
    return Optional.of(fieldRule)
      .filter(Marc2ldFieldRule::isAppend)
  ...
  private Resource createResource(
    ...
    parentResource.getOutgoingEdges()
      .add(new ResourceEdge(parentResource, edgeResource, fieldRule.getPredicate()));
    return edgeResource;
  }
}
