...
@Builder
@AllArgsConstructor
public class Marc2ldFieldRuleImpl implements Marc2ldFieldRule {
  ...
  @NonNull
  private final Collection<Marc2ldFieldRule> edgeRules;
  @NonNull
  ...
  @Override
  public Collection<Marc2ldFieldRule> getEdgeRules() {
    return edgeRules;
  }
  ...
  @Override
  public Collection<Map<String, List<String>>> createProperties(
    DataField dataField,
  ...
  @Override
  public Map<String, List<String>> mergeProperties(
    DataField dataField,
    Collection<ControlField> controlFields,
