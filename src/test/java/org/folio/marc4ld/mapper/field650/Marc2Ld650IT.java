...
class Marc2Ld650IT extends Marc2LdTestBase {
  ...
  void shouldMapField650() {
    ...
    validateResource(
      ...
      Map.ofEntries(
        Map.entry("http://bibfra.me/vocab/library/locationOfEvent", List.of("location of event")),
        ...
        Map.entry("http://bibfra.me/vocab/library/miscInfo", List.of("misc info")),
        ...
        Map.entry("http://bibfra.me/vocab/library/geographicCoverage", List.of("geographic coverage")),
