...
class Marc2Ld130IT extends Marc2LdTestBase {
  ...
  void shouldMapMarc130ToHub() {
    ...
    var node130 = stream(marcNode.get("fields").spliterator(), false)
      ...
      .findFirst()
      .orElse(null);
    var expectedMarcKey = JSON_MAPPER.writeValueAsString(node130);

    var expectedHubLabel = "d-1 a-2 g-3 f-4 k-6 l-7 m-8 o-10 r-12 r-13 s-14 t-15 n-9 p-11. l-7";
    ...
    var expectedTitleProps = Map.of(
      "http://bibfra.me/vocab/library/mainTitle", List.of("d-1 a-2 g-3 f-4 k-6 l-7 m-8 o-10 r-12 r-13 s-14 t-15"),
    ...
    // then
    var expectedTitleLabel = "d-1 a-2 g-3 f-4 k-6 l-7 m-8 o-10 r-12 r-13 s-14 t-15 n-9 p-11";
