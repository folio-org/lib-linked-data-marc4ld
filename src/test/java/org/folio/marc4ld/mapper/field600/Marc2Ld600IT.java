...
class Marc2Ld600IT extends Marc2LdTestBase {
  ...
  void shouldMapField600(String marcFile, String subjectType) {
    ...
    validateResource(
      ...
      Map.ofEntries(
        Map.entry("http://bibfra.me/vocab/library/numeration", List.of("numeration")),
        Map.entry("http://bibfra.me/vocab/lite/name", List.of("name")),
        Map.entry("http://bibfra.me/vocab/library/titles", List.of("title 1", "title 2")),
        Map.entry("http://bibfra.me/vocab/library/attribution", List.of("attribution")),
    ...
    validateResource(
      ...
      Map.of(
        "http://bibfra.me/vocab/library/numeration", List.of("numeration"),
        "http://bibfra.me/vocab/lite/name", List.of("name"),
        "http://bibfra.me/vocab/library/titles", List.of("title 1", "title 2"),
